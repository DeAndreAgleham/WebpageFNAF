...
setTimeout(function morningTime(){
    document.location.href = "/Night/EndNight/endNight.html"
}, 359900)
...
function timer(){
    ...
    if (count <= 0){
        ...
        document.getElementById("rightDoor").style.backgroundColor = "rgb(35, 35, 35)";
        document.getElementById("leftDoor").style.backgroundColor = "rgb(35, 35, 35)";
        ...
        setTimeout(function(){
            ...
            setTimeout(function(){
                ...
                setTimeout(function(){
                    ...
                    setTimeout(function(){
                        document.location.href = "/Night/gameOver/gameOver.html"
                    }, 4000)
                }, 5000)
            }, 13000)
        }, 7000)
...
function rightLighttgl(){
    if(rl.value == "OFF"){
        ...
        if(randRH == 3 || randRH == 11 || randRH == 27 || randRH == 39 || randRH == 41 || randRH == 59 || randRH == 75 || randRH == 80 || randRH == 90 || randRH == 91){
            botAtDoor.play();
        }
        rl.value = "ON";
    } else if(rl.value == "ON"){
...
function leftLighttgl(){
    if(ll.value == "OFF"){
        ...
        if(randLH == 9 || randLH == 18 || randLH == 34 || randLH == 46 || randLH == 47 || randLH == 51 || randLH == 54 || randLH == 67 || randLH == 69 || randLH == 81){
            botAtDoor.play();
        }
        ll.value = "ON";
    } else if(ll.value == "ON"){
...
var rms = 7000;
var func = function () {
    randRH = getRightRandomInt(1, 100);    // Gets random number between 1 and 100
    if(randRH == 14 || randRH == 44 || randRH == 48 || randRH == 60 || randRH == 100){     //FREDDY Control 
        freddyLaugh.play();
        setTimeout(function(){
            if(rt.value == "CLOSE"){
                freddyLaugh.pause();
    ...
    }else if(randRH == 3 || randRH == 11 || randRH == 27 || randRH == 39 || randRH == 41 || randRH == 59 || randRH == 75 || randRH == 80 || randRH == 90 || randRH == 91){
...
var lms = 7000;
var func = function () {
    randLH = getRightRandomInt(1, 100);    // Gets random number between 1 and 100
    if(randLH == 26 || randLH == 94){     //FOXY Control 
        foxyLaugh.play();
        setTimeout(function(){
            foxyLaugh.pause();
    ...
    }else if(randLH == 9 || randLH == 18 || randLH == 34 || randLH == 46 || randLH == 47 || randLH == 51 || randLH == 54 || randLH == 67 || randLH == 69 || randLH == 81){
